...
- `knowledge_checklist.md` when the caller asks to check conformance or review knowledge quality.
...
- `output/check` — check conformance and quality with `knowledge_checklist.md`.
- `output/review` — review quality with `knowledge_checklist.md`.
