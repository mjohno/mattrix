...
- Recognize only exact commands: `deactivate security` and `reactivate security`.
...
- Successful deactivation: `Deactivated: security.`
- Successful reactivation: `Reactivated: security.`
