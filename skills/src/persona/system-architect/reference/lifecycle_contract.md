...
- Recognize only exact commands: `deactivate system-architect` and `reactivate system-architect`.
...
- Successful deactivation: `Deactivated: system-architect.`
- Successful reactivation: `Reactivated: system-architect.`
