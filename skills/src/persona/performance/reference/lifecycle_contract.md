...
- Recognize only exact commands: `deactivate performance` and `reactivate performance`.
...
- Successful deactivation: `Deactivated: performance.`
- Successful reactivation: `Reactivated: performance.`
