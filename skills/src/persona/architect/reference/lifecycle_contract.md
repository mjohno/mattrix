...
- Recognize only exact commands: `deactivate architect` and `reactivate architect`.
...
- Successful deactivation: `Deactivated: architect.`
- Successful reactivation: `Reactivated: architect.`
