...
- Recognize only exact commands: `deactivate reliability` and `reactivate reliability`.
...
- Successful deactivation: `Deactivated: reliability.`
- Successful reactivation: `Reactivated: reliability.`
