...
- Recognize only exact commands: `deactivate documenter` and `reactivate documenter`.
...
- Successful deactivation: `Deactivated: documenter.`
- Successful reactivation: `Reactivated: documenter.`
