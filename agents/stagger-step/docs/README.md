...
```bash
STEP_FILE=STEP-example.yaml python -m stagger_step.cli init --goal "Ship the change" --reference "Specification: docs/spec.md" --reference "Rubric: docs/rubric.md" --change artifacts --commit --packet_history 3 --coordinator-model gpt-5.6-terra --coordinator-thinking medium
